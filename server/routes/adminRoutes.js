...
const { loginController, userPanel, doctorpanel, doctorDetails, doctorVerify, userCount, addSpeciality, getSpecialities, deleteSpeciality } = require('../controllers/adminController');
