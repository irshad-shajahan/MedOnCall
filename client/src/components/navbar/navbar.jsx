          ...
          <div className="shadow-md w-full fixed top-0 left-0">
            <div className=" md:flex items-center justify-between bg-blue-900 ">
              ...
              >
                ...
                <button type='button' className='text-2xl bg-blue-900 text-white font-[poppins] pt-2 px-3 rounded md:ml-8 hover:bg-blue-400 duration-500' onClick={logout}><ion-icon name="log-out-outline"/></button>
              </ul>
            </div>
          </div>
