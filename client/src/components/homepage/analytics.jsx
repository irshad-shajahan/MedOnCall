    ...
    <div className="w-full bg-purple- py-16 px-4">
      <div className="max-w-[1240px] mx-auto grid md:grid-cols-2">
        ...
        <div className='flex flex-col justify-center'> 
          ...
          <button onClick={()=>navigate('/user/consultDoctor')} className='rounded bg-blue-700 w-[200px] text-white font-semibold my-6 mx-auto py-2' type='button'>Consult Now</button>
        </div>
      </div>
    </div>
  );
